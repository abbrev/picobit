...
#if (MAX_VEC_ENCODING > 8191)
#error MAX_VEC_ENCODING > 8191
#endif

#if (MAX_RAM_ENCODING > 8191)
#error MAX_RAM_ENCODING > 8191
#endif
...
{
	return ((((o) - MIN_ROM_ENCODING) << 2) + (4 + (f)));
}
...
#define OBJ_TO_ROM_ADDR(o,f) ((((o) - MIN_ROM_ENCODING) << 2) + (4 + (f)))
