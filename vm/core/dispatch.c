...
dispatch:
	...
	case PUSH_CONSTANT1 :
		...
		IF_TRACE(fprintf(stderr, "  (push-constant "); show_obj (bytecode_lo4); fprintf (stderr, ")\n"));
	...
	case PUSH_CONSTANT2 :
		...
		IF_TRACE(fprintf(stderr, "  (push-constant "); show_obj (bytecode_lo4+16); fprintf (stderr, ")\n"));
	...
	case PUSH_STACK1 :
		...
		IF_TRACE(fprintf(stderr, "  (push-stack %d)\n", bytecode_lo4));
	...
	case PUSH_GLOBAL :
		...
		IF_TRACE(fprintf(stderr, "  (push-global %d)\n", bytecode_lo4));
	...
	case SET_GLOBAL :
		...
		IF_TRACE(fprintf(stderr, "  (set-global %d)\n", bytecode_lo4));
	...
	case CALL :
		...
		IF_TRACE(fprintf(stderr, "  (call %d)\n", bytecode_lo4));
	...
	case JUMP :
		...
		IF_TRACE(fprintf(stderr, "  (jump %d)\n", bytecode_lo4));
	...
	case LABEL_INSTR :
		...
		case 0: // call-toplevel
			...
			IF_TRACE(fprintf(stderr, "  (call-toplevel 0x%04x)\n",
		...
		case 1: // jump-toplevel
			...
			IF_TRACE(fprintf(stderr, "  (jump-toplevel 0x%04x)\n",
			                ((arg2 << 8) | bytecode) + CODE_START));
		...
		case 2: // goto
			...
			IF_TRACE(fprintf(stderr, "  (goto 0x%04x)\n",
			                (arg2 << 8) + bytecode + CODE_START));
		...
		case 3: // goto-if-false
			...
			IF_TRACE(fprintf(stderr, "  (goto-if-false 0x%04x)\n",
			                (arg2 << 8) + bytecode + CODE_START));
		...
		case 4: // closure
			...
			IF_TRACE(fprintf(stderr, "  (closure 0x%04x)\n", entry));
		...
		case 5: // call-toplevel-rel8
			...
			IF_TRACE(fprintf(stderr, "  (call-toplevel-rel8 0x%04x)\n", pc + bytecode - 128));
		...
		case 6: // jump-toplevel-rel8
			...
			IF_TRACE(fprintf(stderr, "  (jump-toplevel-rel8 0x%04x)\n", pc + bytecode - 128));
		...
		case 7: // goto-rel8
			...
			IF_TRACE(fprintf(stderr, "  (goto-rel8 0x%04x)\n", pc + bytecode - 128));
		...
		case 8: // goto-if-false-rel8
			...
			IF_TRACE(fprintf(stderr, "  (goto-if-false-rel8 0x%04x)\n", pc + bytecode - 128));
		...
		case 9: // closure-rel8
			...
			IF_TRACE(fprintf(stderr, "  (closure-rel8 0x%04x)\n", entry));
		...
		case 14: // push_global [long]
			...
			IF_TRACE(fprintf(stderr, "  (push-global [long] %d)\n", bytecode));
		...
		case 15: // set_global [long]
			...
			IF_TRACE(fprintf(stderr, "  (set-global [long] %d)\n", bytecode));
	...
	case PUSH_CONSTANT_LONG :
		...
		IF_TRACE(fprintf(stderr, "  (push [long] 0x%04x)\n", (bytecode_lo4 << 8) + bytecode));
	...
	case JUMP_TOPLEVEL_REL4 :
		...
		IF_TRACE(fprintf(stderr, "  (jump-toplevel-rel4 0x%04x)\n", pc + (bytecode & 0x0f)));
	...
	case GOTO_IF_FALSE_REL4 :
		...
		IF_TRACE(fprintf(stderr, "  (goto-if-false-rel4 0x%04x)\n", pc + (bytecode & 0x0f)));
